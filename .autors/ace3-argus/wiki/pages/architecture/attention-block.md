...
FP16 probability/value products exactly in Q48, rounds the sum to Q24 with RNE,
then rounds Q24 to FP16 with RNE, and reports required V misses. This is a
two-rounding boundary, not direct FP16 rounding of the exact dot product; the
two recurrences can differ near FP16 midpoints. Exact zero is returned as +0.
