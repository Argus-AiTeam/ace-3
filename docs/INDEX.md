...
| [Uniform residual-association bounded RTL agreement](results/ACE3_UNIFORM_RESIDUAL_BOUNDED_RTL_20260908.md) / [Compact summary](results/ACE3_UNIFORM_RESIDUAL_BOUNDED_RTL_20260908.json) | Independently reviewed candidate: 538 passing comparisons (4 changed layer-0 residuals, 532 stages across layers 1–7 / positions 0–3, and 2 position-independent layer-8 endpoint stages), plus 28,682 operator cases; separate binary64-v1 eligibility remains unsatisfied; no full layer-8 position-3 or new-token claim |
